...
class _CollegeWidgetState extends State<CollegeWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CollegeModel());
        ...
        child: Column(
          ...
          children: [
                ...
                children: [
                  Align(
                    ...
                    child: ClipRRect(
                      ...
                      child: Image.network(
                        'https://hhsbuzzer.com/wp-content/uploads/2021/12/www.usnews.jpg',
                        width: double.infinity,
                        height: 130.0,
                        fit: BoxFit.cover,
                      ),
                              ...
                              Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'ytzyzitk' /* Digital skills > College */,
                                  ),
            ...
            Padding(
              ...
              child: Text(
                FFLocalizations.of(context).getText(
                  'hg2mdvam' /* The college admissions process... */,
                ),
